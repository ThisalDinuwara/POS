    ...
    public partial class Supplier : Form
    {
        ...
        private void dgvSupplier_CellContentClick(object sender, DataGridViewCellEventArgs e)
        {
            ...
            else if (colName == "Delete")
            {
                ...
                {
                    cn.Open();
                    cm = new SqlCommand("Delete from tblSupplier where id like '" + dgvSupplier.Rows[e.RowIndex].Cells[1].Value.ToString() + "'", cn);
                    cm.ExecuteNonQuery();
                    cn.Close();
                    MessageBox.Show("Recod has been successfully deleted", "Delete Record", MessageBoxButtons.OK, MessageBoxIcon.Information);
